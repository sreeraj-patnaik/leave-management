...
$historyUrl = buildUserHistoryUrl($user_id, [], '/leave_management_system/student/dashboard.php');
...
$leaveMatrix = buildLeaveRequestMatrix($leaveRows, 'student');
$leaveMatrixLink = static function (array $params = []) use ($user_id) {
    return buildUserHistoryUrl($user_id, $params, '/leave_management_system/student/dashboard.php');
};
...
<div class="main-container">
    ...
    <main class="main-content">
        ...
        <div class="card metric-matrix-card">
            <div class="card-header section-header">
                <div>
                    ...
                    <div class="section-note">Click any number to open that slice of your leave history.</div>
                </div>
                <div class="section-actions">
        ...
        <div class="stats-grid">
            ...
            <a class="stat-card pending" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['status' => 'pending'], '/leave_management_system/student/dashboard.php')); ?>">
                <div class="stat-number"><?php echo (int)$summary['pending_requests']; ?></div>
                <div class="stat-label">Pending</div>
            </a>
            <a class="stat-card approved" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['status' => 'approved'], '/leave_management_system/student/dashboard.php')); ?>">
                <div class="stat-number"><?php echo (int)$summary['approved_requests']; ?></div>
                <div class="stat-label">Approved</div>
            </a>
            <a class="stat-card rejected" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['status' => 'rejected'], '/leave_management_system/student/dashboard.php')); ?>">
                <div class="stat-number"><?php echo (int)$summary['rejected_requests']; ?></div>
                <div class="stat-label">Rejected</div>
            </a>
            <a class="stat-card open" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['status' => 'open'], '/leave_management_system/student/dashboard.php')); ?>">
            ...
            <div class="analytics-grid">
                ...
                <div class="analytics-card">
                    ...
                    <div class="bar-chart">
                        ...
                        <a class="bar-item" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['year' => $analytics['active_year'], 'month' => $monthRow['month']], '/leave_management_system/student/dashboard.php')); ?>">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a class="proof-link" href="<?php echo htmlspecialchars(buildUserHistoryUrl($user_id, ['leave_type' => $leave['leave_type']], '/leave_management_system/student/dashboard.php')); ?>">
