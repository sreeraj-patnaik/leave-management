...
$department_filter = strtolower(trim($_GET['department'] ?? $_GET['report_department'] ?? ''));
...
$currentUrl = '/leave_management_system/principal/requests.php' . (!empty($currentFilters) ? '?' . http_build_query($currentFilters) : '');
?>
...
<div class="main-container">
    ...
    <main class="main-content">
        <div class="content-header">
            ...
            <p class="page-subtitle">Filter the complete list and open each applicant’s history or review page.</p>
        </div>
        ...
        <div class="card">
            <form method="GET" class="filter-form report-filter-form">
                ...
                <div class="filter-actions">
                    ...
                    <a class="btn btn-secondary" href="/leave_management_system/principal/requests.php">Reset</a>
                </div>
            </form>
            ...
            <div class="filter-chip-row">
                ...
                <span class="filter-chip">Department: <?php echo htmlspecialchars($department_filter === '' ? 'All Departments' : (getDepartmentLabel($department_filter) ?: strtoupper($department_filter))); ?></span>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (!empty($request['regd_no']) || !empty($request['emp_no'])): ?>
                                <br><small><?php echo htmlspecialchars(getIdentifierValue($request)); ?></small>
                                <?php endif; ?>
                            </td>
